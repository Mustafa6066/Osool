...
ROUTE_PATTERNS = {
    ...
    RouteType.SEARCH: [
        r"(شقة|apartment|flat|فيلا|villa|بنتهاوس|penthouse|دوبلكس|duplex|تاون|townhouse|سكن|بيت|منزل)",
        r"(عايز|أريد|أبحث|looking for|searching|find me|show me|أبي|بدور|محتاج)",
