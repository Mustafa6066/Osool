...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      ...
      <body className="antialiased bg-[var(--color-background)] text-[var(--color-text-primary)] transition-colors duration-500 min-h-screen w-full relative selection:bg-[var(--color-primary)] selection:text-white">
        <ThemeProvider>
          <LanguageProvider>
            <AuthProvider>
