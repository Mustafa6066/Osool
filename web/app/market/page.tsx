        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 md:p-12">
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                <div className="space-y-4">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white">Egypt Real Estate Pulse</h1>
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={i} className="p-6 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
                ...
                <div className="h-96 bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 flex items-center justify-center p-8 text-center">
                    <div className="space-y-4 max-w-md">
                        <div className="w-16 h-16 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto text-slate-400">
                            <TrendingUp size={32} />
                        </div>
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white">Detailed Charts Coming Soon</h3>
