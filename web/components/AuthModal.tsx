                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                <Mail className="absolute start-3 top-3 text-[var(--color-text-muted)]" size={18} />
                                <input
                                    type="email"
                                    required
                                    value={email}
                                    onChange={(e) => setEmail(e.target.value)}
                                    className="w-full ps-10 pe-4 py-2.5 bg-[var(--color-surface-elevated)] border border-[var(--color-border)] rounded-xl text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]/20 focus-visible:border-[var(--color-primary)] transition-all outline-none"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <Lock className="absolute start-3 top-3 text-[var(--color-text-muted)]" size={18} />
                                <input
                                    type="password"
                                    required
                                    value={password}
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-[var(--osool-accent)] hover:bg-[var(--osool-accent-dark)] text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-[var(--osool-accent-mid)] flex items-center justify-center gap-2 disabled:opacity-50"
                        >
                            {isLoading ? (
                                <>
                    ...
                    <div className="mt-6 pt-4 border-t border-[var(--color-border)] text-center">
                        <p className="text-sm text-[var(--color-text-muted)]">
                            ...
                            <Link
                                href="/signup"
                                className="text-[var(--osool-accent)] font-semibold hover:underline"
                                onClick={onClose}
                            >
